        ...
        <div class="container_form">
            ...
            <form method="POST" action="" onsubmit="return check_form_validity()">
                <div class="mb-3">
                    ...
                    <input name="mail" type="email" class="form-control" id="exampleFormControlInput1" required>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Password *</label>
                    <input name="password_log" type="password" class="form-control" id="exampleFormControlInput1" required>
                </div>
